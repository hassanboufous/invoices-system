				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
                            ...
                            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الفواتير</span>
                        </div>
                        </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                  ...
                  <a href="{{route('invoices.export')}}" class="btn btn-success">
                    <span class="px-5 font-weight-bold"> تصدير اكسيل</span>
                  </a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @php $i++ @endphp
                                    <tr class="text-center">
                                        ...
                                        <td class="d-flex">
                                            <div class="dropdown">
                                                <button aria-expanded="false" aria-haspopup="true" class="btn-sm ripple btn-primary"
                                                data-toggle="dropdown" type="button">الاعدادات<i class="fas fa-caret-down ml-1"></i></button>
                                                <div class="dropdown-menu tx-16">
                                                    <a class="dropdown-item text-warning text-center bg-light font-weight-bold"
                                                        href="{{route('invoices.edit',$invoice->id)}}">تعديل</a>

                                                    <a class="dropdown-item text-info text-center bg-light font-weight-bold"
                                                        href="{{route('invoice.status.edit',$invoice->id)}}" >حالة الفاتورة</a>

                                                    <a class="dropdown-item text-primary text-center bg-light font-weight-bold"
                                                        href="{{route('invoices.print',$invoice->id)}}" >طباعة</a>

                                                        <form action="{{route('invoices.destroy',$invoice->id)}}" method="POST" >
                                                        @csrf
                                                        @method('DELETE')
                                                    <button type="submit" class="dropdown-item text-danger bg-light text-center font-weight-bold">حدف</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </td>
